      ...
      .then(res => {
        if (!res.rowCount) {
          ...
          client.query({
            ...
            values: [process.env.LIBRARY, process.env.MAIL_SENDER, 'Hello world !', process.env.MAIL_SENDER, process.env.SMTP_HOST, process.env.SMTP_PASSWD, process.env.PG_PASSWD, '../src/scss/wallpaper.jpg']
          })
          .then(res => {
